...
----------------------
STEP 2: CREATE GITHUB REPOSITORY(git repo) means GitHub project folders. We must create a repository to store projects.
...
DONE*****
*********Git Push Practice*********
After the first push, we do not use some of teh git commits that we used in the first commit.
